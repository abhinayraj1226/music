...
class MusicGenreList {
  ...
  Map<String, dynamic> toJson() => {
        "music_genre": musicGenre == null ? null : musicGenre.toJson(),
      };
}
...
class MusicGenre {
  ...
  factory MusicGenre.fromJson(Map<String, dynamic> json) => MusicGenre(
        musicGenreId:
            json["music_genre_id"] == null ? null : json["music_genre_id"],
        musicGenreParentId: json["music_genre_parent_id"] == null
            ? null
            : json["music_genre_parent_id"],
        musicGenreName:
            json["music_genre_name"] == null ? null : json["music_genre_name"],
        musicGenreNameExtended: json["music_genre_name_extended"] == null
            ? null
            : json["music_genre_name_extended"],
        musicGenreVanity: json["music_genre_vanity"] == null
            ? null
            : json["music_genre_vanity"],
      );

  Map<String, dynamic> toJson() => {
        "music_genre_id": musicGenreId == null ? null : musicGenreId,
        "music_genre_parent_id":
            musicGenreParentId == null ? null : musicGenreParentId,
        "music_genre_name": musicGenreName == null ? null : musicGenreName,
        "music_genre_name_extended":
            musicGenreNameExtended == null ? null : musicGenreNameExtended,
        "music_genre_vanity":
            musicGenreVanity == null ? null : musicGenreVanity,
      };
}
